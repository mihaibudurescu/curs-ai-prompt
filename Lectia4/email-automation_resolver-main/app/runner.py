...
def run_code():
    ...
    result = pipeline.run(bugs="""import json
    import os
    import hashlib
    ...
    class FitnessAssistant:
        ...
        def _chunk_text(self, text: str) -> list[str]:
            splitter = RecursiveCharacterTextSplitter(
                # BUG 5: chunk_size este prea mic. Valoarea corecta este 300.
                chunk_size=30,
                chunk_overlap=20,
            )
        ...
        def _build_faiss_index_from_chunks(self, chunks: list[str]) -> faiss.IndexFlatIP:
            ...
            # BUG 7: Dimensiunea indexului este hardcodata la 1. Trebuie sa folosesti dimensiunea reala a embeddings.
